...
export const barrelParts: WeaponPart[] = [
  // BASIC TIER
...
export const triggerParts: WeaponPart[] = [
  // BASIC TIER
...
export const stockParts: WeaponPart[] = [
  // BASIC TIER
...
export const magazineParts: WeaponPart[] = [
  // BASIC TIER
...
export const scopeParts: WeaponPart[] = [
  // BASIC TIER
...
export const gripParts: WeaponPart[] = [
  // BASIC TIER
...
export const muzzleParts: WeaponPart[] = [
  // BASIC TIER
...
export const underbarrelParts: WeaponPart[] = [
  // BASIC TIER
...
export const allWeaponParts = {
  ...
  grip: gripParts,
  muzzle: muzzleParts,
  underbarrel: underbarrelParts
};

// Export function to get parts by slot and tier
export function getPartsBySlotAndTier(
  slot: WeaponPart['slot'], 
  tier?: WeaponPart['tier'],
  minQuality?: number,
  maxQuality?: number
): WeaponPart[] {
  let parts = allWeaponParts[slot] || [];
  ...
  if (minQuality !== undefined && maxQuality !== undefined) {
    parts = parts.filter(p => 
      p.qualityRange[0] <= maxQuality && p.qualityRange[1] >= minQuality
    );
  }
...
export function getCompatibleParts(quality: number, masteryLevel: number): Map<string, WeaponPart[]> {
  const compatible = new Map<string, WeaponPart[]>();
  
  Object.entries(allWeaponParts).forEach(([slot, parts]) => {
    const validParts = parts.filter(part => 
      part.qualityRange[0] <= quality && 
