...
export interface LootConfig {
    loot_categories: {
        [category: string]: LootCategory;
    };
    spawn_locations: {
        [location: string]: SpawnLocation;
    };
...
export interface EconomyTierBasedLoot {
    weapon_rarity_scaling: {
        [tier: string]: WeaponRarityScaling;
    };
    equipment_by_tier: {
        [tier: string]: EquipmentByTier;
    };
    special_drops_by_biome: {
        [biome: string]: SpecialDropByBiome;
    };
    economic_scaling: {
        [tier: string]: number;
    };
