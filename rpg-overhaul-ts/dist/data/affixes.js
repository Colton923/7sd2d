...
exports.allAffixes = exports.mastercraftedAffixes = exports.uniqueAffixes = exports.implicitAffixes = exports.suffixAffixes = exports.prefixAffixes = void 0;
exports.getAffixesByType = getAffixesByType;
exports.getCompatibleAffixes = getCompatibleAffixes;
// ============================================================================
// PREFIX AFFIXES - Primary weapon modifiers
// ============================================================================
exports.prefixAffixes = [
    // ===== DAMAGE PREFIXES =====
...
exports.allAffixes = {
    prefix: exports.prefixAffixes,
    suffix: exports.suffixAffixes,
    implicit: exports.implicitAffixes,
    unique: exports.uniqueAffixes,
    mastercrafted: exports.mastercraftedAffixes
};
// Export convenience function to get affixes by type
function getAffixesByType(type) {
    return exports.allAffixes[type] || [];
}
// Export function to get compatible affixes for a weapon type
function getCompatibleAffixes(weaponType, affixType) {
    return getAffixesByType(affixType).filter(affix => affix.weaponTypes.includes('all') || affix.weaponTypes.includes(weaponType));
}
