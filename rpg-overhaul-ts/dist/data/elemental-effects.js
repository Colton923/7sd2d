...
exports.elementalCombos = exports.elementalEffects = exports.ElementalType = void 0;
exports.getElementalInteraction = getElementalInteraction;
exports.calculateElementalDamage = calculateElementalDamage;
var ElementalType;
(function (ElementalType) {
    ...
    ElementalType["Radiation"] = "radiation";
    ElementalType["Explosive"] = "explosive";
    ElementalType["Bleeding"] = "bleeding";
    ElementalType["Void"] = "void";
    ElementalType["Holy"] = "holy";
    ElementalType["Chaos"] = "chaos";
    ElementalType["Plasma"] = "plasma";
    ElementalType["Corrosive"] = "corrosive";
    ElementalType["Sonic"] = "sonic";
    ElementalType["Psychic"] = "psychic";
    ElementalType["Quantum"] = "quantum";
})(ElementalType || (exports.ElementalType = ElementalType = {}));
exports.elementalEffects = {
    [ElementalType.None]: {
...
function getElementalInteraction(element1, element2) {
    return exports.elementalCombos.find(combo => combo.elements.includes(element1) && combo.elements.includes(element2)) || null;
}
// Calculate elemental damage
function calculateElementalDamage(baseDamage, elementalType, enemyType) {
    const effect = exports.elementalEffects[elementalType];
...
//# sourceMappingURL=elemental-effects.js.map